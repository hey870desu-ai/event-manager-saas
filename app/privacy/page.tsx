        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="p-8 md:p-12 space-y-10 text-sm md:text-base leading-relaxed">
            ...
            <section>
              ...
              <p>当社は，ユーザーが本サービスを利用する際、氏名，会社名，部署名，メールアドレス，電話番号などの個人情報を取得することがあります。また、ユーザーが主催するイベントの参加者が入力した情報についても、本サービスの提供・運営のために取得します。</p>
            </section>
            ...
            <section>
              ...
              ・本サービスの提供・運営のため<br />
              ・ユーザーからの心合わせに対応するため（本人確認を行うことを含む）<br />
              ・ユーザーが利用中のサービスの新機能，更新情報等の送付のため<br />
              ・メンテナンス，重要なお知らせなど必要に応じたご連絡のため<br />
              ・有料サービスにおいて，ユーザーに利用料金を請求するため</p>
            </section>

            <section>
              <h2 className="text-lg font-bold border-l-4 border-emerald-600 pl-3 mb-4 text-slate-900">第4条（個人情報の第三者提供）</h2>
            ...
            <section>
              ...
              <p>ユーザーは，当社の保有する自己の個人情報が誤った情報である場合には，当社に対し，個人情報の訂正，追加または削除を請求することができます。当社は，ユーザーからこれらの請求を受けた場合，遅滞なく調査を行い，対応いたします。</p>
            </section>
