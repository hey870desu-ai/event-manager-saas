...
function SuccessContent() {
  ...
  const [ticketData, setTicketData] = useState<{
    ...
    eventId: string;
    tenantId: string;
    paymentStatus: string; // ★追加：支払いステータスを受け取る
  } | null>(null);
    ...
    const verifyPayment = async () => {
      try {
        ...
        setTicketData({
          ...
          paymentStatus: data.paymentStatus || "paid", // ★APIが返さない場合は一旦paid扱い（後述）
        });
